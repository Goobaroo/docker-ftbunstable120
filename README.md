# [FTB Unstable 1.20: Forge](https://feed-the-beast.com/modpack/110-ftb_unstable_1_20:_forge) By FTB
...
The docker on first run will download the same version as tagged of `FTB Unstable 1.20: Forge` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "FTB Unstable 1.20: Forge Server Powered by Docker"
* LEVEL world
...
## Source
Github: https://github.com/Goobaroo/docker-ftbunstable120

Docker: https://hub.docker.com/repository/docker/goobaroo/ftbunstable120